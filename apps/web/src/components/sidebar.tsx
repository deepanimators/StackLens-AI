    ...
    >
      ...
      <div className="p-6 border-b border-border bg-gradient-to-br from-primary to-secondary">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">StackLens AI</h1>
            <p className="text-sm text-white/80">Intelligent Log Analysis</p>
          </div>
        </div>
      </div>
          ...
          return (
            <Link key={item.name} href={item.href}>
              ...
              >
                ...
                {isAiFeature && (
                  <span className="ml-2 px-2 py-1 bg-secondary/20 text-xs rounded-md font-medium">
                    AI
                  </span>
                )}
              </Button>
            ...
            <Link href="/admin">
              <Button
                ...
                className={cn(
                  ...
                  location !== "/admin" && "hover:bg-muted hover:shadow-md"
                )}
              >
                <Shield
                  className={cn(
                ...
                <span className="ml-2 px-2 py-1 bg-red-500/20 text-xs rounded-md font-medium">
                  ADMIN
                </span>
              </Button>
            </Link>
